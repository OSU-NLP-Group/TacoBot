...
from tacobot.log.log_formatting import TacoFormatter
...
def setup_logger(logger_settings, session_id=None):
    ...
    # For complicated reasons, that means we need to set tacologger to have the desired level (not the handlers)
