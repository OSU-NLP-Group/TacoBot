...
class Template(Annotator):
    def __init__(self, state_manager: StateManager, timeout=3, url=None, input_annotations = []):
        super().__init__(state_manager=state_manager, timeout=timeout, url=url, input_annotations=input_annotations, name="template"
)
    ...
    def execute(self, input_data=None):
        ...
        logger.debug(f'Calling Template Annotator Remote module with utterances="{user_utterances}"')
