...
# from taco.core.taco_util import get_function_version_to_display
import taco.core.taco_flags as flags
...
from taco.core.taco_handler import Handler
from taco.core.taco_logging_utils import setup_logger, update_logger, PROD_LOGGER_SETTINGS
...
class LocalAgent():
    ...
    def create_handler(self):
        return Handler(
            ...
            annotator_classes = [QuestionAnnotator, DialogActAnnotator, NavigationalIntentModule, StanfordnlpModule, CorenlpModule, BlenderBot],
