...
def write_preprocessed_blacklist():
     ...
     outfile = os.path.join(os.path.dirname(__file__), '../../../taco/core/offensive_classifier/data_preprocessed/offensive_phrases_preprocessed.txt')

     # Load and preprocess our additional blacklist
     blacklist_file_path = os.path.join(os.path.dirname(__file__), '../../../taco/core/offensive_classifier/data_original/full-list-of-bad-words_text-file_2018_07_30.txt')
