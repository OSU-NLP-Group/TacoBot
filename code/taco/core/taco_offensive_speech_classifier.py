...
from taco_util import load_text_file, contains_phrase

logger = logging.getLogger('TacoBot')
...
class OffensiveSpeechClassifier(object):
    ...
    preprocessed_blacklist_file = os.path.join(os.path.dirname(__file__), 'offensive_classifier/data_preprocessed/offensive_phrases_preprocessed.txt')
    ...
    def classify(self, text: str, log_message: str = 'text "{}" contains offensive phrase "{}"') -> bool:
        """
