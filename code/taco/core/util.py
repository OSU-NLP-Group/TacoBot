...
from taco.core.canary import is_already_canary
import threading
...
taco_RP_NAME = ['CATEGORIES', 'FOOD', 'FALLBACK', "NEURAL_CHAT", 'NEURAL_FALLBACK', 'WIKI', 'TRANSITION']

config_fname = 'taco/core/es_config.json'
...
def get_user_datetime(user_timezone=None) -> Optional[datetime.datetime]:
    """
    Returns the datetime, now, in the user's timezone.

    If we don't have the user's timezone, returns None
    """
