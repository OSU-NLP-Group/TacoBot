...
from taco.core.response_priority import ResponsePriority, PromptType, TiebreakPriority, PROMPT_TYPE_DIST, PROMPT_DISTS_OVER_RGS
...
from taco.core.util import sample_from_prob_dist_dict, normalize_dist
...
#
    ...
    def rank_responses(self, responses: Dict[str, ResponseGeneratorResult]):
        ...
        priority_sorted_responses = sorted(responses.items(),
                                           ...
                                           reverse=True)
        # print('priority_sorted_responses = ', priority_sorted_responses)
