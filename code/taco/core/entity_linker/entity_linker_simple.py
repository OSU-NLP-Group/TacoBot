...
from taco.core.entity_linker.entity_linker import link_spans, sort_linked_spans
...
from taco.core.util import make_text_like_user_text
...
if __name__ == "__main__":
    ...
    from taco.core.latency import save_latency_plot, clear_events
