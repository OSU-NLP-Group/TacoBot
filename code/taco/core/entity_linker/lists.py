...
import os
from taco.core.util import get_unigram_freq_fn, load_text_file
from taco.core.entity_linker.util import wiki_url_to_name
from taco.core.entity_linker.util import NUMBER_ALTERNATIVES
...
DONT_LINK_WORDS.update(set(['question', 'subject', 'conversation', 'talk', 'chat', 'watched', 'watching',
...
# Load spoken unigram frequencies from taco/data/2_2_spokenvwritten.txt
...
# This list was initialized with the ngrams from taco/data/2_2_spokenvwritten.txt
LOW_PREC_SPANS = set(
