...
from taco.core.entity_linker.util import wiki_name_to_url
from taco.core.latency import measure
from taco.response_generators.categories.categories import CATEGORYNAME2CLASS
from taco.core.offensive_classifier.offensive_classifier import contains_offensive
from taco.core.util import filter_and_log, make_text_like_user_text
from taco.core.entity_linker.lists import MANUAL_SPAN2ENTINFO, ENTITY_WHITELIST, WIKIDATA_CATEGORY_WHITELIST, STOPWORDS, DONT_LINK_WORDS
from taco.core.entity_linker.thresholds import SCORE_THRESHOLD_ELIMINATE_DONT_LINK_WORDS, SCORE_THRESHOLD_ELIMINATE, SCORE_THRESHOLD_ELIMINATE_HIGHFREQUNIGRAM_SPAN, UNIGRAM_FREQ_THRESHOLD, SCORE_THRESHOLD_EXPECTEDTYPE
...
class EntityLinkerResult(object):
    ...
    def __init__(self, high_prec: List[LinkedSpan] = [], threshold_removed: List[LinkedSpan] = [],
                 conflict_removed: List[LinkedSpan] = [], ingrident_high_prec: List[LinkedSpan] = [], pak_high_prec: List[LinkedSpan] = []):
        """
        ...
        self.ingrident_high_prec = ingrident_high_prec
        self.pak_high_prec = pak_high_prec
    ...
    def __repr__(self):
        return f'<EntityLinkerResults: ingrident_high_prec={self.ingrident_high_prec}, pak_high_prec={self.pak_high_prec}, \
        high_prec={self.high_prec}, threshold_removed={self.threshold_removed}, conflict_removed={self.conflict_removed}>'
