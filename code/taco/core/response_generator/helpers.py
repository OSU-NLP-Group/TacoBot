...
from taco.core.regex.word_lists import CUTOFF
from taco.core.regex import response_lists

from taco.core.regex.templates import (
...
from taco.response_generators.personal_issues.regex_templates import PersonalSharingTemplate
...
from taco.core.util import load_text_file, contains_phrase
...
CATEGORIES_SUP_TOPICS = ['game', 'animals', 'history', 'books', 'art', 'cars', 'school', 'anime', 'pets', 'baseball', 'tv show', 'cooking', 'dance', 'celebrities', 'travel', 'hockey']


taco_RP_NAME = ['CATEGORIES', 'FOOD', 'FALLBACK', "NEURAL_CHAT", 'NEURAL_FALLBACK', 'WIKI', 'ALIENS', 'LAUNCH', 'ACKNOWLEDGMENT', 'PERSONAL_ISSUES', 'OFFENSIVE_USER', 'TRANSITION']
