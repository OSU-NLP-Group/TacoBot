from taco.core.response_generator_datatypes import emptyResult, ResponseGeneratorResult, emptyPrompt, ResponsePriority
from abc import ABC
import logging
from taco.core.response_generator.response_type import ResponseType
from taco.core.response_generator.state import BaseState, BaseConditionalState
from taco.core.response_generator.helpers import construct_response_types_tuple
...
class Treelet(ABC):
    ...
    def treet_update_current_state(self, state, conditional_state):
        pass
