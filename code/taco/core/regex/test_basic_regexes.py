...
Run:
    python -m unittest -v taco/core/regex/test_basic_regexes.py
"""

import unittest
import re

import taco.core.regex.util
from taco.core.regex import templates
...
class TestBasicRegexes(unittest.TestCase):
    ...
    def test_optional_text(self):
        self.assert_regex_matchexact(taco.core.regex.util.OPTIONAL_TEXT,
                                     positive_examples=['', 'hello', 'hello world'],
                                     negative_examples=[])

    def test_nonempty_text(self):
        self.assert_regex_matchexact(taco.core.regex.util.NONEMPTY_TEXT,
                                     positive_examples=['hello', 'hello world'],
                                     negative_examples=[''])

    def test_optional_text_pre(self):
        self.assert_regex_matchexact(taco.core.regex.util.OPTIONAL_TEXT_PRE,
                                     positive_examples=['', 'hello ', 'hello  ', 'hello world ', ' hello ', ' '],
                                     negative_examples=['hello', ' hello'])

    def test_optional_text_post(self):
        self.assert_regex_matchexact(taco.core.regex.util.OPTIONAL_TEXT_POST,
                                     positive_examples=['', ' hello', '  hello', ' hello world', ' hello ', ' '],
                                     negative_examples=['hello', 'hello '])

    def test_optional_text_mid(self):
        self.assert_regex_matchexact(taco.core.regex.util.OPTIONAL_TEXT_MID,
                                     positive_examples=[' ', ' hello ', ' hello world '],
