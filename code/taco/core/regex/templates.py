...
import logging
from taco.core.regex import word_lists, response_lists
...
class HowAreYouTemplate(RegexTemplate):
    ...
    positive_examples = [
        ...
        ('tell me about your day', {'how_are_you_noncontextual': 'your day'}),
...
class StopTemplate(RegexTemplate):
    ...
    negative_examples = [
        ...
        'okay i\'m done answering your questions',
...
class TryingToStopTemplate(RegexTemplate):
    ...
    slots = {
        ...
        "stop_precise": word_lists.STOP_LESS_PRECISE,
        "goback": ["back", "enough chatting"],
        'maintask': ['recipe', 'task', 'ongoing task', 'job']
    }
    templates = [
        ...
        "help",
        "go back",
        OPTIONAL_TEXT_PRE + "{goback}" + OPTIONAL_TEXT + "{maintask}"  + OPTIONAL_TEXT_POST,
    ...
    positive_examples = [
        ...
        ('okay i\'m done answering your questions', {'stop_precise': 'i\'m done'}),
...
class CriticismTemplate(RegexTemplate):
    ...
    positive_examples = [
        ...
        ("you're so buggy", {'criticism': 'so buggy'}),
        ("why are you so bad", {'criticism': 'so bad'}),
        ("no stupid", {'criticism': 'stupid'}),
        ("go home you're drunk", {'criticism': 'drunk'}),
        ("that's dumb", {'criticism': 'dumb'}),
        ("you suck", {'criticism': 'suck'}),
        ("shut up you're annoying", {'criticism': 'annoying'}),
...
class ComplaintClarificationTemplate(RegexTemplate):
    ...
    positive_examples = [
        ("what", {}),
        ("what do you mean", {"clarifying_question": "what do you mean"}),
...
class ComplaintMisheardTemplate(RegexTemplate):
    """Match user saying the bot misheard them"""
    slots = {
    ...
    positive_examples = [
        ...
        ("that's not what i said", {"misheard": "not what i said"}),
        ("you didn't listen", {"misheard": "you didn't listen"}),
...
class ComplaintRepetitionTemplate(RegexTemplate):
    """Match user saying the bot is repeating itself"""
    slots = {
    ...
    positive_examples = [
        ...
        ("stop repeating yourself", {"repetition": "stop repeating"}),
        ("you are repeating the same thing", {"repetition": "you are repeating"}),
...
class ComplaintPrivacyTemplate(RegexTemplate):
    ...
    positive_examples = [
        ...
        ("that's not your business", {"privacy": "not your business"}),
...
class WhatAboutYouTemplate(RegexTemplate):
    ...
    positive_examples = [
        ...
        ("what about you. I don't really remember", {'what_about_you': "what about you"}),
        ("I don't actually remember. how about you", {'what_about_you': "how about you"}),
    ]
    negative_examples = [
        'i know',
        'what did you just say'
...
class RequestPlayTemplate(RegexTemplate):
    slots = {
        "request": ["can you", "could you", "can we", "could we", "please", "let's"],
    }
    templates = [
...
class ComplimentTemplate(RegexTemplate):
    ...
    positive_examples = [
        ...
        ("thank you for talking to me", {"thank": "thank you", "talk": "talking"}),
...
class RequestAgeTemplate(RegexTemplate):
    ...
    positive_examples = [
        ...
        ("what's your age", {"request": "what's"}),
