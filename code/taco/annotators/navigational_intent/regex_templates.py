...
from taco.core.regex.util import one_or_more_spacesep, oneof, NONEMPTY_TEXT, OPTIONAL_TEXT_PRE, OPTIONAL_TEXT_POST
from taco.core.regex.word_lists import INTENSIFIERS
from taco.response_generators.fallback.response_templates import FALLBACK_PROMPTS
from taco.response_generators.neural_chat.util import question_part
...
class NegativeNavigationTemplate(RegexTemplate):
    ...
    positive_examples = [
        ...
        ('change the subject please', {'change_the_subject': 'change the subject'}),
...
class PositiveNavigationTemplate(RegexTemplate):
    ...
    positive_examples = [
        ('can you please talk something else', {'nav': 'can you please talk', 'topic': 'something else'}),
        ...
        ("do you know much i'm not sure if you do but yeah anything about whales", {'nav_about': "do you know much i'm not sure if you do but yeah anything about", 'topic': 'whales'}),
