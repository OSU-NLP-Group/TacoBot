...
# from taco.response_generators.food.regex_templates import FavoriteTypeTemplate
# from taco.core.response_generator_datatypes import PromptType, ResponseGeneratorResult
