import re
from taco.core.callables import RemoteCallable, get_url
from taco.core.response_generator.response_type import ResponseType, add_response_types
import logging
...
IDENTITY_QUESTIONS = [
    ((r'[\w\s\']*your name[\w\s]*', r'[\w\s\']*you called[\w\s]*'),  "I am taco bot"),
    ((r'[\w\s\']*who are you$', r'[\w\s\']*who you are$', r'[\w\s\']*who built you$', r'[\w\s\']*who made you$', r'[\w\s\']*who are you made by$',
      r'[\w\s\']*what are you$', r'[\w\s\']*tell me about yourself[\w\s]*', r'[\w\s\']*tell me about you$'), 'I am taco bot built by OSU NLP group.'),
...
RECORD_RESPONSE = "I'm designed to protect your privacy."
