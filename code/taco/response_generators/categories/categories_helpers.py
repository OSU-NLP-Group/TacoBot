...
from taco.response_generators.categories.regex_templates import CategoriesTemplate
from taco.response_generators.categories.categories import CATEGORYNAME2CLASS, ACTIVATIONPHRASE2CATEGORYNAME
