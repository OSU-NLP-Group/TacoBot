...
from taco.core.response_generator_datatypes import emptyResult, ResponseGeneratorResult
from taco.core.response_generator_datatypes import PromptResult, emptyPrompt, UpdateEntity
from taco.response_generators.opinion2.opinion_sql import get_opinionable_phrases
from taco.response_generators.wiki2.blacklists import ENTITY_BLACK_LIST
from taco.core.response_generator import *
from taco.response_generators.acknowledgment.state import *
...
class AcknowledgmentResponseGenerator(ResponseGenerator):
    ...
    def handle_default_post_checks(self) -> ResponseGeneratorResult:
        ...
        if not current_state.entity_tracker.cur_entity_initiated_by_user_this_turn(self.state_manager):
