...
from taco.core.response_generator_datatypes import emptyResult, ResponseGeneratorResult, PromptResult, emptyPrompt, \
    UpdateEntity
from taco.core.regex.templates import MyNameIsNonContextualTemplate, MyNameIsNotTemplate
from taco.core.util import contains_phrase
...
from taco.response_generators.one_turn_hack.responses import *
from taco.response_generators.one_turn_hack.one_turn_hack_utils import *
from taco.response_generators.one_turn_hack.regex_templates import *
from taco.response_generators.one_turn_hack.state import State, ConditionalState
...
class OneTurnHackResponseGenerator(ResponseGenerator):
    ...
    def handle_default_post_checks(self):
        ...
        # # Check for user asking to repeat
            ...
            logger.primary_info("User has praised")
