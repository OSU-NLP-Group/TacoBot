...
def taco_recipe_show_steps(current_state, last_state, user_attributes):
    ...
    speak_output, document = get_recipe_steps(current_task_docparse, current_step, user_attributes)
...
def get_recipe_steps(current_task_docparse, current_step, user_attributes):
    """
    Arguments:
    ...
    speak_output = decorate_speak_output(user_attributes, speak_output)
