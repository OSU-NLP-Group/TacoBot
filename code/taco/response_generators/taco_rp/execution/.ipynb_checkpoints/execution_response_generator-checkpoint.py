...
NAME2TREELET = {treelet.__name__: treelet for treelet in [Taco_execution_Treelet]}
...
class execution_Generator(ResponseGenerator):
    ...
    def __init__(self, state_manager) -> None:
        ...
        treelets = {
            treelet.name: treelet for treelet in [self.Taco_execution_Treelet]
        }
    ...
    def handle_default_post_checks(self) -> Optional[ResponseGeneratorResult]:
        ...
        treelet = name2initializedtreelet['Taco_execution_Treelet']
