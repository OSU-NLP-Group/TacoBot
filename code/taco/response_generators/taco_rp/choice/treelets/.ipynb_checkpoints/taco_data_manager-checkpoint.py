...
def manage_search_data(current_state, last_state, user_attributes, toolkit_service_client):
    ...
    query_result = None
    if not query or intent == 'RecommendIntent' or True:
...
#     taco.response_generators.taco_rp.choice.data
#     github/tacobot_v2/taco/response_generators/taco_rp/choice/data/example_cache.json
