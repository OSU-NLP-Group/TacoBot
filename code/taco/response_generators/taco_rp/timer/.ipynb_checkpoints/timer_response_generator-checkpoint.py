...
from ask_sdk_model.services.timer_management.timer_management_service_client import TimerManagementServiceClient

from cobot_core.alexa_timer_management import AlexaTimerManagement
