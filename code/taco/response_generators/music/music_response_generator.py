...
from taco.response_generators.music.regex_templates.word_lists import KEYWORD_MUSIC
import taco.response_generators.music.treelets as treelets
import taco.response_generators.music.music_helpers as helpers
from taco.response_generators.music.music_helpers import ResponseType, tags
from taco.response_generators.music.state import State, ConditionalState
from taco.core.entity_linker.entity_groups import ENTITY_GROUPS_FOR_EXPECTED_TYPE
from taco.core.entity_linker.entity_linker_simple import link_span_to_entity
from taco.response_generators.music.utils import MusicBrainzInterface
...
class MusicResponseGenerator(ResponseGenerator):
    ...
    def try_talking_about_fav_song_else_exit(response=''):
        ...
        Not sure if we want taco to keep talking about itself.
        """
