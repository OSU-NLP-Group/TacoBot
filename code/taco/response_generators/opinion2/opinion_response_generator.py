...
from taco.core.response_generator_datatypes import emptyResult
from taco.core.entity_linker.entity_groups import ENTITY_GROUPS_FOR_CLASSIFICATION
from taco.response_generators.opinion2.policies.two_turn_agree_policy import TwoTurnAgreePolicy
from taco.response_generators.opinion2.policies.disagree_agree_switch_agree_policy import DisagreeAgreeSwitchAgreePolicy
from taco.response_generators.opinion2.policies.short_soft_disagree_policy import ShortSoftDisagreePolicy
from taco.annotators.corenlp import Sentiment, CorenlpModule
import re
import random
import logging
from collections import defaultdict
import taco.response_generators.opinion2.utils as utils
import taco.response_generators.opinion2.state_actions as state_actions
import taco.response_generators.opinion2.opinion_sql as opinion_sql
from typing import List, Optional, Tuple
from taco.core.entity_linker.entity_linker_classes import WikiEntity
from taco.core.entity_linker.entity_linker_simple import get_entity_by_wiki_name
from taco.response_generators.opinion2.constants import ACTION_SPACE
from taco.response_generators.opinion2.policies.baseline_policies import AlwaysAgreePolicy
from taco.response_generators.opinion2.policies.always_disagree_policy import AlwaysDisagreePolicy
from taco.response_generators.opinion2.policies.disagree_agree_policy import DisagreeAgreePolicy
from taco.response_generators.opinion2.policies.disagree_switch_agree_policy import DisagreeSwitchAgreePolicy
from taco.response_generators.opinion2.policies.soft_disagree_switch_agree_policy import SoftDisagreeSwitchAgreePolicy
from taco.core.response_generator_datatypes import PromptResult, ResponseGeneratorResult, UpdateEntity, emptyPrompt, emptyResult
from taco.response_generators.opinion2.state_actions import Action, AdditionalFeatures, State
from taco.response_generators.opinion2.utterancify import fancy_utterancify, fancy_utterancify_prompt
from taco.core.response_priority import ResponsePriority, PromptType
from taco.core.response_generator.neural_helpers import get_neural_fallback_handoff
from taco.core.util import DAYS_OF_WEEK, contains_phrase, get_eastern_dayofweek

from taco.core.response_generator.state import NO_UPDATE
...
class OpinionResponseGenerator2(ResponseGenerator):
    ...
    def __init__(self, state_manager) -> None:
        ...
        self.logger = logging.getLogger('tacologger')
