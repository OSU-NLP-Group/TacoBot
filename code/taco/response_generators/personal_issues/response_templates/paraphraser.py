...
from taco.response_generators.personal_issues.response_templates.response_components import QUESTIONS_REFLECTIVE, \
...
class TemplateBasedParaphraser(object):
    ...
    def add_sentiment_phrases(self, sentiment: Sentiment, paraphrase: str,
        ...
        Args:
            sentiment (Sentiment): The annotator sentiment returned by the CoreNLP annotator
                (see ...taco/annotators/corenlp.py); used for selecting adjectives with appropriate
                valence.
    ...
    def sample_pre_text(self, sentiment: Sentiment) -> str:
        ...
        Args:
            sentiment (Sentiment): Sentiment enum from CoreNLP annotator (see ...cobot/taco/annotators/corenlp.py),
    ...
    def paraphrase(self, state) -> str:
        ...
        1. Extract the top verbphrase from the CoreNLP annotator (see ...cobot/taco/annotators/corenlp.py). This
