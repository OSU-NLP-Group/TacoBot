import csv
from taco.response_generators.offensive_user.data.templates import InappropOffensesTemplate, SexualOffensesTemplate
from taco.core.regex.templates import CriticismTemplate
