...
import logging
from agents.taco_local_agent import LocalAgent
from taco.core.taco_logging_utils import LoggerSettings, setup_logger
from servers.local.local_callable_manager import LocalCallableManager

TACO_HOME = os.environ.get('TACO_HOME', Path(__file__).parent.parent)
callable_config={
    "question": {
        "port": "3100",
